...
say Don't forget to wear that item(s) I gave you...
~
#3017
Mortal Greet~
2 s 100
...
~
set max %random.3%
set text[1] If you have no gear, you can go east and get a free set...
set text[2] Help TELEPORTER will assist you in getting around...
set text[3] Go up to visit the MUD training area...
eval speech %%text[%max%]%%
say %speech%
~
#3019
Obj Command 3019 - portal to Sanctus~
1 c 7
en~
